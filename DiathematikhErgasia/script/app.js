...
let muteunmutetxt =  document.getElementById("muteunmute-btn");
...
mutebtn.addEventListener("click",()=>{
  muteunmutetxt.innerText = audioStatus;
  audioStatus = audioStatus == "Mute" ? "Unmute" : "Mute";
});
for (let i = 0; i < allButtons.length; i++) {
  allButtons[i].addEventListener('click', PlaySound)
}
function PlaySound(){
  audioStatus == "Unmute" ?  squareSound.play() : false;
}  
